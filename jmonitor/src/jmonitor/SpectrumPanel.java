...
/*
 * Revsion History
 * 2/01/13: Updated the panel dimension to 960x200. Updated the declarations:
 *              1. WIDTH = 960
 *              2. HEIGHT = 200
 *              3. SAMPLES = 960
 *          Also changed the switch(SampleRate) case to decrease the increments 
 *          by 50% to accomdate the doubling in size of the spectrum
 * 
...
public class SpectrumPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(960, 200));
    ...
    public void drawSpectrum(int offset, int localOscOffset) {
        ...
        if(image!=null) {
            ...
            // decreased the increments by 50% to accomdate the doubling in size of the spectrum
            switch(sampleRate) {
                case 48000:
                    increment=50;               //Was 100
                    break;
                case 96000:
                    increment=100;              //Was 200
                    break;
                case 192000:
                    increment=200;              //Was 400
                    break;
                default:
                    increment=100;              //Was 200
                    break;
            ...
            for(int i=0;i<WIDTH;i++) {
                if((f%10000)<increment) {        // Changed f%20000 to f%10000
            ...
            for(int i=1; i<numSteps; i++)
            {
                ...
                graphics.drawString(Integer.toString(num)+" dBm",3,y+2);
            }
    ...
    private static final int SAMPLES=960;       //Was 480 (020113)
    private static final int WIDTH=960;         //Was 480 (020113)
    private static final int HEIGHT=200;        //Was 100 (020113)
