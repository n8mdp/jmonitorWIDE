...
/*
 * Revsion History
 * 2/01/13: Updated the panel to support a larger dimension
 * 
...
public class MonitorPanel  extends javax.swing.JPanel implements MonitorUpdateListener {
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(962, 520));
        setRequestFocusEnabled(false);
        setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        spectrumPanel.setAlignmentX(0.0F);
        spectrumPanel.setAlignmentY(0.0F);
        spectrumPanel.setMaximumSize(new java.awt.Dimension(960, 200));
        spectrumPanel.setMinimumSize(new java.awt.Dimension(960, 200));
        ...
        add(spectrumPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 120, -1, -1));
        spectrumPanel.getAccessibleContext().setAccessibleName("");

        waterfallPanel.setAlignmentX(0.0F);
        waterfallPanel.setAlignmentY(0.0F);
        waterfallPanel.setMaximumSize(new java.awt.Dimension(960, 200));
        waterfallPanel.setMinimumSize(new java.awt.Dimension(480, 100));
        waterfallPanel.setPreferredSize(new java.awt.Dimension(960, 200));
        ...
        add(waterfallPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 320, -1, 340));

        controlPanel.setBackground(new java.awt.Color(0, 0, 0));
        add(controlPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 960, 120));
